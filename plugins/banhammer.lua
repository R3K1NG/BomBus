...
if not is_gbanned(data.id_) then
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "`نمیتونی پیام های ادمینارو پاک کنی`", 0, "md")
   end
  else
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "_You can't delete messages mods,owners or bot admins_", 0, "md")
     elseif lang then
   return tdcli.sendMessage(msg.chat_id_, "", 0, "`نمیتونی پیام های ادمینارو پاک کنی`", 0, "md")
   end
     else
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if is_mod1(msg.chat_id_, matches[2]) then
    ...
    return tdcli.sendMessage(msg.chat_id_, "", 0, "`نمیتونی ادمینارو محروم کنی`", 0, "md")
        end
     end
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "`نمیتونی ادمینارو سایلنت کنی`", 0, "md")
        end
     end
   ...
   return tdcli.sendMessage(msg.chat_id_, "", 0, "`کاربر "..matches[2].." از قبل سایلنت بود`", 0, "md")
        end
     end
