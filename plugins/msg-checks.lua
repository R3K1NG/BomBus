...
local data = load_data(_config.moderation.data)
 msg.text = msg.content_.text_
  ...
  tdcli.sendMessage(msg.chat_id_, "", 0, "*This Is Not One Of My Groups*", 0, "md")
...
return
   ...
   del_msg(msg.chat_id_, msg.id_)
    kick_user(user, chat)
  tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "_User_ `[ "..user.." ]` *kicked* _For_ *flooding*", 0, "md")
