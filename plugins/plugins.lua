...
local function run(msg, matches)
  ...
  if is_sudo(msg) then
  if matches[1]:lower() == '!pl' or matches[1]:lower() == '/pl' or matches[1]:lower() == '#pl' then --after changed to moderator mode, set only sudo
  ...
  if matches[1]:lower() == 'rel' and is_sudo(msg) then --after changed to moderator mode, set only sudo
    return reload_plugins(true)
  end
end
