...
if is_admin1(tonumber(data.id_)) then
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `از قبل ادمین ربات بود`", 0, "md")
      end
   end
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `به مقام ادمین ربات منتصب شد`", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not is_admin1(data.id_) then
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `از قبل ادمین ربات نبود`", 0, "md")
      end
   end
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `از مقام ادمین ربات برکنار شد`", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if already_sudo(tonumber(data.id_)) then
  if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `از قبل سودو ربات بود`", 0, "md")
      end
   end
  ...
  if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `به مقام سودو ربات منتصب شد`", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
user_name = data.first_name_
   ...
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `از قبل سودو ربات نبود`", 0, "md")
      end
   end
   ...
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "`کاربر` "..user_name.." *"..data.id_.."* `از مقام سودو ربات برکنار شد`", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
